...
public class BookingTools {
    ...
    @Tool
    public void changeBooking(String bookingNumber, String firstName, String lastName, String date, String from, String to, String bookingClass) {
        carRentalService.changeBooking(bookingNumber, firstName, lastName, date, from, to, bookingClass);
    }
