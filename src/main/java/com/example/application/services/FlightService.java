...
public class FlightService {
    ...
    HashMap<String, BookingClass> classMapping = new HashMap<>();


    public FlightService() {
        db = new BookingData();
        classMapping.put("economy",BookingClass.ECONOMY);
        classMapping.put("premiumeconomy",BookingClass.PREMIUM_ECONOMY);
        classMapping.put("business",BookingClass.BUSINESS);
        initDemoData();
    }
    ...
    public void changeBooking(String bookingNumber, String firstName, String lastName, String newDate, String from, String to, String bookingClass) {
        BookingClass bClass = classMapping.get(bookingClass.replaceAll("\\s+","").toLowerCase());
        ...
        booking.setTo(to);
        booking.setBookingClass(bClass);
    }
